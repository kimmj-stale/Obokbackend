...
struct MainView: View {
    ...
    func loadTodayDiaries() {
        ...
        todayDiaries = [
            ...
            Diary(id: UUID(), date: Date(), title: "사회 읽기", content: "근현대사 복습", subject: "사회", understandingLevel: 6, distractions: [], improvements: []),
            Diary(id: UUID(), date: Date(), title: "생명과학 공부", content: "세포 분열", subject: "생명", understandingLevel: 2, distractions: [], improvements: [])
        ]
    }
}
